...
<tr>
	...
	<a href="https://ng.istandwithjesus.org/autopay.php" onClick='return confirm ("Do you really want to withdraw for all member?");' ><button class="btn btn-success">Auto Withdraw for all Members</button></a>
</tr>
