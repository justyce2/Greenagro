...
class ZPage extends XPage
{
    ...
    function ocd_list ()
    {
       ...
       //$this->Redirect ("http://ng.istandwithjesus.org");
        $ennnn =  $this->GetGP("enroller");
       
        
       if($this->GetGP("changeref")){
        
        
         
            $this->redirect($thisSiteUrl."/signup.php?ref=". $ennnn);
        }
...
//        $enroller_s = "<input type='text' name='enroller' value='".$enroller."' maxlength='10' style='width: 100px;' onKeyDown='return false;' onKeyUp='return false;'><br>";
        ...
        //$enroller_s = $dict['Left_YEn']."$enrollerName <input type='text' name='enroller' value='".$enrollerName."' maxlength='10' style='width: 100px; ' onKeyDown='return false;' onKeyUp='return false;' >";
        $enroller_s = $dict['Left_YEn']." <input type='text' name='enroller' value='".$enrollerName."' maxlength='10' style='width: 100px;  >";
        ...
        $this->data = array (
            ...
            "MAIN_ENROLLER_C" => $enroller,
            "MAIN_LASTNAME" => $last_name,
            "MAIN_FIRSTNAME" => $first_name,
            "MAIN_EMAIL" => $email,
            "MAIN_USERNAME" => $username,
            "MAIN_BANKNAME" => $bankname,
            "MAIN_PHONE" => $phone,
            "MAIN_STREET" => $street,
            "MAIN_CITY" => $city,
            "MAIN_STATE" => $state,
            "MAIN_COUNTRY" => $country,
            "MAIN_BANKACCNAME" => $bankaccname,
            "MAIN_BANKACCNO" => $bankaccno,
    ...
    function ocd_register ()
    {
        ...
        $username = $this->enc($this->GetValidGP ("username", "Username", VALIDATE_USERNAME));
         ...
         $bankaccname = $this->enc($this->GetValidGP ("bankaccname", "Bank Acc Name", VALIDATE_NOT_EMPTY));
         $bankname = $this->enc($this->GetValidGP ("bankname", "Bank name", VALIDATE_NOT_EMPTY));
          $bankaccno = $this->enc($this->GetValidGP ("bankaccno", "Bank Acc No", VALIDATE_NOT_EMPTY));
          
     $phone= $this->enc($this->GetValidGP ("phone", "Phone", VALIDATE_NOT_EMPTY));
     
      $street = $this->enc($this->GetValidGP ("street", "Street", VALIDATE_NOT_EMPTY));;
          $city = $this->enc($this->GetValidGP ("city", "City", VALIDATE_NOT_EMPTY));;
          $state = $this->enc($this->GetValidGP ("state", "State", VALIDATE_NOT_EMPTY));;
          $country = $this->enc($this->GetValidGP ("country", "Country", VALIDATE_NOT_EMPTY));;
      ...
      //  $enroller = $this->GetGP ("enroller", "enroller", VALIDATE_NOT_EMPTY);
...
$enroller = $this->GetSession ("enroller", 1);
        ...
        if ($this->errors['err_count'] > 0)
        {
          ...
          $enroller_s = $dict['Left_YEn']." <input type='text' name='enroller' value='".$enrollerName."' maxlength='10' style='width: 100px; '  >";
            ...
            $this->data = array (
                ...
                "MAIN_ENROLLER" => $enroller_s,
                "MAIN_ENROLLER_B" => $enroller_b,
                "MAIN_LASTNAME" =>$last_name, //"<input type='text' name='last_name' value='$last_name' maxlength='50' style='width: 200px;'>",
                "MAIN_LASTNAME_ERROR" => $this->GetError ("last_name"),
                "MAIN_FIRSTNAME" => $first_name, // "<input type='text' name='first_name' value='".$first_name."' maxlength='50' style='width: 200px;'>",
                ...
                "MAIN_BANKNAME" => $bankname,
                "MAIN_BANKNAME_ERROR" => $this->GetError ("bankname"),
            "MAIN_BANKACCNAME" => $bankaccname,
             "MAIN_BANKACCNAME_ERROR" => $this->GetError ("bankaccname"),
             
            "MAIN_BANKACCNO" => $bankaccno,
             "MAIN_BANKACCNO_ERROR" => $this->GetError ("bankaccno"),
               "MAIN_PHONE" => $phone,
               
             "MAIN_PHONE_ERROR" => $this->GetError ("phone"),
             
             
                 "MAIN_STREET" =>  $street,
                 "MAIN_STREET_ERROR" =>  $this->GetError ("street"),
                    "MAIN_CITY" => $city,
                    "MAIN_CITY_ERROR" => $this->GetError ("city"),
                    "MAIN_STATE" => $state,
                    "MAIN_STATE_ERROR" => $this->GetError ("state"),
                    "MAIN_COUNTRY" => $this->GetError ("country"),
                "MAIN_PASSWORD" =>$password, //"<input type='password' name='password' value='$password' maxlength='12' style='width: 120px;'>",
                "MAIN_PASSWORD_ERROR" => $this->GetError ("password"),
                "MAIN_PASSWORD2" =>$password2, //"<input type='password' name='password2' value='$password2' maxlength='12' style='width: 120px;'>",
        ...
        else
        {
          ...
          // $enroller_id= $enroller;

           // $password = UniKey();
            $password_code = md5 ($password);
          
           // $this->db->ExecuteSql ("Insert into `members` (username, email,first_name,last_name,  passwd, enroller_id, reg_date, is_active, account_id, account_name, bank_name, phone) values ('$username', '$email','$first_name','$last_name', '$password_code', '$enroller_id', '".time()."', '1', '$bankaccno', '$bankaccname', '$bankname', '$phone')");
           
            
             $this->db->ExecuteSql ("Insert into `members` (username, email,first_name,last_name,  passwd, enroller_id, reg_date, is_active, account_id, account_name, bank_name, phone, street, city, state, country) values ('$username', '$email','$first_name','$last_name', '$password_code', '$enroller_id', '".time()."', '1', '$bankaccno', '$bankaccname', '$bankname', '$phone', '$street', '$city', '$state', '$country')");
            ...
            if ($useValidation == 1)
            {
              ...
              //  $this->Redirect ("thank_you.php?email=$email");
               $this->Redirect ("login.php?reg=yes");
            }
            else
            {
