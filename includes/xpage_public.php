...
class XPage
{
    ...
    function HeaderCode()
    {
        ...
        $hdrMenuAbout = "<td class='left_" . $index_class . "'></td><td class='center_" . $index_class . "'><a href='#about' class='menu'>About Us</a></td><td class='right_" . $index_class . "'></td>";
        $hdrMenuPlan = "<td class='left_" . $index_class . "'></td><td class='center_" . $index_class . "'><a href='#plan' class='menu'>Plan</a></td><td class='right_" . $index_class . "'></td>";
        ...
        $signup_class = (basename($this->pageUrl) == "signup.php") ? "active" : "";
         $reff =  $this->GetGP("ref");
                $reff =  (!empty($reff))?  '?ref='.$reff :  "";
        $hdrMenuSignUp = "<td class='left_" . $signup_class . "'></td><td class='center_" . $signup_class . "'><a href='signup.php".$reff."' class='menu'>Sign Up</a></td><td class='right_" . $signup_class . "'></td>";
        ...
        $datas = array(
            ...
            "MENU_ABOUT" => "<li><a href='#about' >About Us</a></li>",
            "MENU_PLAN" => "<li><a href='#plan' >Plan</a></li>",
            "MENU_CONTACT" => "<li><a href='#contact' >Contact Us</a></li>",
            "MENU_LOGIN" => $hdrMenuLogin,
            "MENU_SIGNUP" => $hdrMenuSignUp,
            "MENU_NEWS" => "<li><a href='/news.php' >{$dict['News']}</a></li>",
            "MENU_FAQ" => "<li><a href='/faq.php' >{$dict['Faq']}</a></li>",//$hdrMenuFaq,
