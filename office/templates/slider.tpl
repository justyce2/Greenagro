...
<table width='100%' border='0' cellspacing='0' cellpadding='2' class="simple-little-table">
    <tr>
        <td colspan="2">
		<form action='/office/slider.php' method='POST'  enctype='multipart/form-data'>
		...
		Only png, jpg, gif files. Size should be 1280*500px.<br>
                ...
                <input class='some_btn' type='button' value=" Cancel " onClick="window.location.href='/office/slider.php'" style="padding: 6px 15px; width: initial;" >
        </form>
	</td>
        <td width='5%'></td>
    </tr>
