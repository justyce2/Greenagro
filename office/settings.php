...
class ZPage extends XPage
{
    ...
    <tr>
        ...
        //    if ($this->LicenseAccess['currency'][$this->lic_key] == 0) $currency = '';
            ...
            $this->db->SetSetting("is_replica", $is_replica);
            $this->db->SetSetting("useBanners", $ptools);
            $this->db->SetSetting("useSecureMembers", $useSecureMembers);
            $this->db->SetSetting("useAutoresponder", $useAutoresponder);
             $this->db->SetSetting("quant_replica", $quant_replica);
            $this->db->SetSetting("useEshop", $useEshop);
             $this->db->SetSetting("useValidation", $useValidation);
            ...
            $this->db->SetSetting("is_pif", $is_pif);
            $this->db->SetSetting("is_pif_cash", $is_pif_cash);
