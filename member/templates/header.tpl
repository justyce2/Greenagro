    ...
    <nav class="navbar navbar-static-top navbar-fixed-top">
      <div class="container">
        <div class="navbar-header">
         ...
         <!-- <a class="" href="./myaccount.php"><img  src="./images/slogo.png" width="100px"/>{SITE_TITLE}</a>-->
            <a class="" href="./myaccount.php"><img alt="{SITE_TITLE}"  src="./images/slogo.png" width="70px"/></a>
        </div>
        <div id="navbar" class="navbar-collapse collapse">
          ...
          <ul class="nav navbar-nav btn-login">
            <li class="login-prof"> {MEMBER_AVATAR}</li> <li class="login-prof"> {DICT.Top_Welcome}<br> {MEMBER_DATA}</li>
