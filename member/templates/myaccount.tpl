...
<!-- tab body Payment -->                             
                            <div role="tabpanel" class="tab-pane {PAYMENTSETTONGS}" id="Payment">                                
                               <form action='{MAIN_ACTION}?paymentsettongs' method='POST'>
                                ...
                                <div class="form-group">
                                    <div class="row">
                                        <span class='error'>{ACCOUNT_BANK_ERROR}</span>
                                        <label class="col-sm-4 control-label">{DICT.MyAcc_Bank} :</label>
                                        <div class="col-sm-8">
                                            {ACCOUNT_BANK}
                                        </div>
                                    </div>    </div> <div class="form-group">
                                    <div class="row">
                                        <span class='error'>{ACCOUNT_NAME_ERROR}</span>
                                        <label class="col-sm-4 control-label">{DICT.MyAcc_Name} :</label>
                                        <div class="col-sm-8">
                                            {ACCOUNT_NAME}
                                        </div>
                                    </div>    
                                ...
                                <!--    <div class="row">
                                        <span class='error'>{ACCOUNT_BANKADDRESS_ERROR}</span>
                                        <label class="col-sm-4 control-label">{DICT.MyAcc_BankAddress} :</label>
                                        <div class="col-sm-8">
                                            {ACCOUNT_BANKADDRESS}
                                        </div>
                                    </div>   --> 
